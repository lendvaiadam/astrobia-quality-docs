...
export class Game {
    ...
    generateUnitTabs() {
        ...
        toggleBtn.innerHTML = '<span class="toggle-icon">Ôľ▓</span>';
    ...
    updateWaypointCurve() {
        ...
        // User Requirement: "Amikor a Command Queueben rendezem ├ít, akkor mind├şg azt c├ęlozza, ami az elhagyott ├íllom├ís ut├ín k├Âvetkezik."
    ...
    updateWaypointMarkerFill() {
        // User Request: "Minden egys├ęg folyamatosan friss├şti... b├írmennyi unit eset├ęn"
            ...
            if (unit.waypointControlPoints && unit.waypointControlPoints.length > 0) {
                ...
                unit.waypointControlPoints.forEach((cp, index) => {
                    ...
                    <div class="command-item ${stateClass}" draggable="true" data-index="${index}">
                        ...
                        <div class="cmd-actions">
                            <button class="cmd-action-btn delete-btn" title="Remove" data-index="${index}">ÔťĽ</button>
                        </div>
                    </div>
                `;
                });
                ...
                commandQueueHTML += `
                    <div class="no-commands">
                        <div class="no-commands-icon">­čôő</div>
                ...
                <div class="panel-container">
                    ...
                    <div class="command-queue">
                        ...
                        <div class="playback-controls">
                            <button class="ctrl-btn primary" id="play-btn">ÔľÂ Play</button>
                            <button class="ctrl-btn" id="pause-btn">ÔĆŞ Pause</button>
                            <button class="ctrl-btn danger" id="clear-btn">ÔťĽ Clear</button>
                        </div>
                        ${commandQueueHTML}
