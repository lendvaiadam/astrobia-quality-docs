# Asterobia — G-R-F-Tr-D-P-U SYSTEM SPECIFICATION (CANONICAL, ENGINE-LEVEL)
...
> **Canonical reference:** See `ASTEROBIA_CANONICAL_MASTER_BIBLE_2026-01-13.md` for the full Goal/Need→Feature table and Starting Central Unit allocation.
