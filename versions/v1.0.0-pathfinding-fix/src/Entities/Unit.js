    ...
    update(input, dt) {
        ...
        if (this.path && this.path.length > 0 && this.isFollowingPath && !this.pausedByCommand && !this.isBouncing && !this.isInTransition) {
            ...
            if (!currentTarget) {
                ...
                // Combine with global speed factor
                let speedFactor = this.speedFactor * tangentSpeedFactor; 
        ...
        if (hasKeyboardInput) {
            ...
            if (this.isKeyboardOverriding) {
                ...
                // After 0.5s of no input, end override mode and pause
                if (this.keyboardOverrideTimer > 0.5) {
                    this.isKeyboardOverriding = false;
                    this.pausedByCommand = true; // Now pause (user must press Play to resume)
                }
            }
        }
